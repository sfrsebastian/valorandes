...
SELECT ID_ASOCIACION as ASOCIACION,ID_VALOR as ID,CANTIDAD,ID_CORREDOR,TIPO AS TIPO_SOL FROM AUTORIZADOS INNER JOIN ASOCIACIONES ON AUTORIZADOS.ID_ASOCIACION = ASOCIACIONES.ID WHERE ASOCIACIONES.ID_USUARIO = '${sessionScope.id}' AND ASOCIACIONES.ACTIVO = '1'
