            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> <c:out value="${sessionScope.usuario}"/></a>
                        </li>
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="/ValorAndes/?logout=si"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="operaciones.jsp">Ordenar Operacion Bursatil</a>
                                </li>
                                <li>
                                    <a href="verOperaciones.jsp">Ver Operaciones</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
